              ...
              <fieldset>
				...
				<div class="form-group">
				  <label class="col-sm-4 control-label">{{Lien au dossier Photos}}</label>
					  ...
					  <img style="max-height : 40px;float:left;margin:0 10px 0 10px;" src="core/img/no_image.gif"  id="img_samba" class="img-responsive" title="Etat de la connexion au dossier via Samba" onerror="this.src='plugins/diaporama/images/question.png'"/>
					  <img style="max-height : 40px;float:left;margin:0 10px 0 10px;" src="core/img/no_image.gif"  id="img_facebook" class="img-responsive" title="Etat de la connexion au compte Facebook" onerror="this.src='plugins/diaporama/images/question.png'"/>				
					  </div>
